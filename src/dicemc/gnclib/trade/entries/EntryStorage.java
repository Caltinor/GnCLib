...
public class EntryStorage implements IBufferable{
	private int id;
	public EntryTransactor owner;
	public String stack;
	public int count;
	
	public EntryStorage(int id, EntryTransactor owner, String itemStack, int count) {
		this.id = id;
		this.owner = owner;
		this.stack = itemStack;
		this.count = count;
	}
	public EntryStorage(EntryTransactor owner, String itemStack, int count) {
